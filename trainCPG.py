...
datapath = r"/home/chenzx/CPG_set/cwe122"

dataset = path2data2.Load_Path_2_DataSet(datapath)
...
plt.savefig("/home/chenzx/train/figure/CPG121loss.png")

plt.close()
plt.xlabel("iteration")
plt.ylabel("test accuracy")
plt.plot(x, testAcc)
plt.savefig("/home/chenzx/train/figure/CPG121acc.png")
