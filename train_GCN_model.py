...
datapath = r"/home/chenzx/testcases/CWE401_Memory_Leak"
...
for epoch in range(1, 201):
    loss = train(epoch)
    train_acc = myTest(trainloader)
    test_acc = myTest(testloader)
    print('Epoch: {:03d}, Loss: {:.5f}, Train Acc: {:.5f},Test Acc: {:.5f}'.
          format(epoch, loss, train_acc, test_acc))

finishTime = time.time()

torch.save(model.state_dict(), r"/home/chenzx/GCNmodel/CWE401.pt")
